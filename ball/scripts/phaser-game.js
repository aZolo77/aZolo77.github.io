...
var startGame = (function() {
    ...
    function preload() {
        ...
        game.load.image('ball', 'ball/images/ball.png');
        game.load.image('paddle', 'ball/images/paddle.png');
        game.load.image('brick', 'ball/images/brick.png');
        game.load.spritesheet('ball', 'ball/images/wobble.png', 20, 20); // параметры нарезки спрайта
        game.load.spritesheet('button', 'ball/images/button.png', 120, 40);
    }
